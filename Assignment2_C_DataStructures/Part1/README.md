...
You *may* also consider writing some unit tests to test your implementation (In fact, I would strongly encourage you to do so). Please include your unit tests in your submission. Some example tests we might come up with include:
